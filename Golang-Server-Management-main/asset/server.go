...
func HandleFunc() {
	...
	mux.HandleFunc("/update_u_comments", func(w http.ResponseWriter, r *http.Request) {
		...
		_, err1 := db.Exec("UPDATE Server_Request SET Creator=$2,Start_Date=$3,End_Date=$4,Manufacturer=$5,Number_Of_Servers=$6,Operating_System=$7,Cpu_model=$8,CPU_Sockets=$9,DIMM_Capacity=$10,Storage_Vendor=$11,Storage_Controller=$12,Storage_Capacity=$13,Network_Type=$14,Network_speed=$15,Number_Of_Network_Ports=$16,Special_Switching_Needs=$17,DIMM_Size=$18 Where ID=$1  ;", v.Id, v.Creator, v.Start_Date, v.End_Date, v.Manufacturer, v.Number_Of_Servers, v.Operating_System, v.Cpu_model, v.CPU_Sockets, v.DIMM_Capacity, v.Storage_Vendor, v.Storage_Controller, v.Storage_Capacity, v.Network_Type, v.Network_speed, v.Number_Of_Network_Ports, v.Special_Switching_Needs, v.DIMM_Size)
	...
	mux.HandleFunc("/my_request", func(w http.ResponseWriter, r *http.Request) {
		...
		for rows.Next() {
			...
			Requests = append(Requests, Server_Request{Id: Id, User_No: User_No, Creator: Creator, Start_Date: Start_Date, End_Date: End_Date, Manufacturer: Manufacturer, Number_Of_Servers: Number_Of_Servers, Operating_System: Operating_System, Cpu_model: Cpu_model, CPU_Sockets: CPU_Sockets, DIMM_Capacity: DIMM_Capacity, Storage_Vendor: Storage_Vendor, Storage_Controller: Storage_Controller, Storage_Capacity: Storage_Capacity, Network_Type: Network_Type, Network_speed: Network_speed, Number_Of_Network_Ports: Number_Of_Network_ports, Special_Switching_Needs: Special_Switching_Needs, Infraadmin_Comments: Infraadmin_Comments, User_Comments: User_Comments, Request: Request})
		}
		rev_slc := []Server_Request{}
